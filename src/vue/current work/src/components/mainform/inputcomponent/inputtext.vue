...
<div>
      ...
      <div class="dragdiv" ref>
        ...
        <div class="pull-right" v-if="activated==true">
            <i class="far fa-edit mar05 clrdrc cuspointer" data-toggle="modal" v-bind:data-target="target"></i>
        ...
        <div class="form-group">
            ...
            <input v-if="binding==true" v-validate="element.validations" :name="element.label" type="text" v-bind:placeholder="element.placeholder" v-model="formVals[index]" class="form-control" id="usr">
            <input v-else type="text" v-bind:placeholder="element.placeholder" class="form-control" id="usr">
        </div>
      </div>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Text attribute form</h4>
              </div>
              <!-- {{$data}} {{element}} -->
              <div class="modal-body">
                ...
                <div class="form-group">
                  ...
                  <input type="integer" class="form-control" v-model="element.min">
                </div>
                <div class="form-group">
                  <label class="lblcustm">Maximum</label>
                  <input type="integer" class="form-control" v-model="element.max">
                </div>
                <div class="form-group">
                      <input type="checkbox" :id="eml_id" name="email" v-model="element.validations['email']">
                      <label :for="eml_id">Email</label>
                  </div>
                <div class="form-group">
                      <input type="checkbox" :id="required_id" name="textrequired" v-model="element.validations['required']">
                      <label :for="required_id">Required</label>
                  </div>
                  <div class="form-group">
                      <input type="checkbox" :id="numeric_id" name="textrequired" v-model="element.validations['numeric']">
                      <label :for="numeric_id">Numeric</label>
                  </div>
              </div>
